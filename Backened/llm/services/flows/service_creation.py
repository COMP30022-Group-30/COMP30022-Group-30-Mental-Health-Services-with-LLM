...
SERVICE_FORM_FIELDS: List[Dict[str, Any]] = [
    ...
    {"id": "suburb", "label": "Suburb", "required": True, "control": "text"},
    {"id": "state", "label": "State", "required": True, "control": "text"},
...
def prepare_payload(form: Dict[str, Any]) -> Dict[str, Any]:
    ...
    normalised: Dict[str, Any] = {
        **form,
        ...
        "service_type": _normalise_list(form.get("service_type")),
        "target_population": _normalise_list(form.get("target_population")),
        ...
        "opening_hours_24_7": _normalise_bool(form.get("opening_hours_24_7")),
        "opening_hours_standard": _normalise_bool(form.get("opening_hours_standard")),
        "opening_hours_extended": _normalise_bool(form.get("opening_hours_extended")),
    }
...
async def submit_service_form(form: Dict[str, Any], session_id: Optional[str] = None) -> Dict[str, Any]:
    ...
    try:
        supabase.client.table("service_submission_requests").insert(storage_record).execute()
